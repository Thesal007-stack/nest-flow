...
export class UserController {
  ...
  public async deleteAvatar(@Req() req: IRequestWithUser) {
    return await this.userService.deleteAvatar(req?.user?.id as string) ;
  }
  ...
  public async addAddress(
    ...
    const { user } = req;
    return await this.userService.createUserAddress(user?.id as string, addressDto);
  }
  ...
  public async updateAddress(
    ...
    const { user } = req;
    return await this.userService.updateUserAddress(user?.id as string, addressDto);
  }
  @Delete('address')
  @UseGuards(JwtAuthGuard)
  public async deleteAddress(@Req() req: IRequestWithUser) {
    const { user } = req;
    return await this.userService.deleteUserAddress(user?.id as string);
  }
  ...
  public async getAllUserFilesFromAWS(@Req() req: IRequestWithUser) {
    return await this.userService.getAllPrivatesFileFromAWS(req?.user?.id as string);
  }
  ...
  public async addMultipleFiles(
    ...
    return await this.userService.addMultiplePrivateFile(user?.id as string, uploadFiles);
  }
